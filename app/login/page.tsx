// app/login/page.tsx  (REPLACE EVERYTHING)
...
export default function LoginPage() {
  return (
    <div className="max-w-md mx-auto p-6 space-y-3">
      ...
      {/* Server-posted form — the API sets cookie + redirects */}
      <form method="POST" action="/api/auth/login?redirect=/admin" className="space-y-3">
        <input
          name="email"
          type="email"
          placeholder="Email"
